...
define(function(require, exports, module) {
  var array_slice = Array.prototype.slice,
    ...
    Enumerable = require('infrastructure/collection/Enumerable'),
  ...
  proto = {
    ...
    each: function(iterator, scope) {
      ...
      for (i = 0, len = items.length; i < len; i++) {
        item = items[i];
        if (iterator.call(scope || item, item, i, me)===false){
          return;
        }
      }
  ...
  List = module.exports = Enumerable.extend('List', proto);
});